...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'"));
t('index sw-marker current shell', H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912'));
