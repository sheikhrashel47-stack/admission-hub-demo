...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v241-zero-raster-3d-student-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v241-zero-raster-3d-student-20260911'));
