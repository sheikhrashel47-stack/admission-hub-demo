...
t('sw BUILD_ID v193-gfix-20260906', SW.includes("const BUILD_ID = 'v193-gfix-20260906'"));
t('index sw-marker v193-gfix-20260906', H.includes('sw.js?v=v193-gfix-20260906'));
