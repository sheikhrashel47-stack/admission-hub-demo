...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v242-3d-dob-wheel-20260912'"));
t('index sw-marker current shell', H.includes('sw.js?v=v242-3d-dob-wheel-20260912'));
