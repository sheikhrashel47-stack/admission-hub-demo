...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v240-code-native-entry-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v240-code-native-entry-20260911'));
