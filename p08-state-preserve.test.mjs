...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v239-native-personal-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v239-native-personal-20260911'));
