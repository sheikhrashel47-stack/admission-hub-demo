...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v234-premium-onboarding-20260911'));
