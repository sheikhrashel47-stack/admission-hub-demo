...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v238-personal-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v238-personal-20260911'));
