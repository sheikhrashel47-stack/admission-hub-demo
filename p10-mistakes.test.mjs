...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v243-premium-dropdown-20260912'"));
t('index sw-marker current shell', H.includes('sw.js?v=v243-premium-dropdown-20260912'));
