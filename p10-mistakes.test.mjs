...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v235-reference-onboarding-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v235-reference-onboarding-20260911'));
