...
/* ৬ — ভার্সন v194 */
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v230-telegram-otp-20260910'"));
t('index sw-marker current shell', H.includes('sw.js?v=v230-telegram-otp-20260910'));
