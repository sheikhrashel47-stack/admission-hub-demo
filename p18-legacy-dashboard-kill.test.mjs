...
t('৫. sw BUILD_ID/expectedSwVersion/cur = v211-aiagent-20260908 + dv2 dash2f6 অটুট', SW.includes("const BUILD_ID = 'v211-aiagent-20260908'") && H.includes('sw.js?v=v211-aiagent-20260908') && H.includes("const expectedSwVersion = 'v211-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v211-aiagent-20260908'") && H.includes('dashboard-v2.js?v=dash2f6'));
