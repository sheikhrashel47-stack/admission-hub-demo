...
t('৫. sw BUILD_ID/expectedSwVersion/cur = v208-aiagent-20260908 + dv2 dash2f6 অটুট', SW.includes("const BUILD_ID = 'v208-aiagent-20260908'") && H.includes('sw.js?v=v208-aiagent-20260908') && H.includes("const expectedSwVersion = 'v208-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v208-aiagent-20260908'") && H.includes('dashboard-v2.js?v=dash2f6'));
