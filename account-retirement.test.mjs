...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v238-personal-20260911'") &&
  H.includes("const expectedSwVersion = 'v238-personal-20260911'") &&
  H.includes('sw.js?v=v238-personal-20260911') &&
  H.includes('admission-hub-shell-v238-personal-20260911'));
...
await test('premium account and institution assets use synchronized cache-busting versions',
  ['account-access.css?v=20260911-static-reference-personal-v1-ai-scope', 'account-access.js?v=20260911-static-reference-personal-v1-ai-scope', 'institutions-bd.js?v=bd-institutions-v1']
    .every(asset => H.includes(asset) && SW.includes(asset)) &&
  H.indexOf('institutions-bd.js?v=bd-institutions-v1') < H.indexOf('account-access.js?v=20260911-static-reference-personal-v1-ai-scope'));
