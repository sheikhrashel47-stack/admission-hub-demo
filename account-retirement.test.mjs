...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'") &&
  H.includes("const expectedSwVersion = 'v242-hero-personal-dob-modern-20260912'") &&
  H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912') &&
  H.includes('admission-hub-shell-v242-hero-personal-dob-modern-20260912'));
...
await test('premium account and institution assets use synchronized cache-busting versions',
  ['account-access.css?v=20260912-hero-personal-dob-modern-v2', 'account-access.js?v=20260912-hero-personal-dob-modern-v2', 'institutions-bd.js?v=bd-institutions-v1']
    .every(asset => H.includes(asset) && SW.includes(asset)) &&
  H.indexOf('institutions-bd.js?v=bd-institutions-v1') < H.indexOf('account-access.js?v=20260912-hero-personal-dob-modern-v2'));
