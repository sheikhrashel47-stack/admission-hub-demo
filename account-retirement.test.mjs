...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v222-native-auth-20260909'") &&
  H.includes("const expectedSwVersion = 'v222-native-auth-20260909'") &&
  H.includes('sw.js?v=v222-native-auth-20260909') &&
  H.includes('admission-hub-shell-v222-native-auth-20260909'));
