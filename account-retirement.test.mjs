...
await test('service-worker build and HTML registration are synchronized',
  SW.includes("const BUILD_ID = 'v243-premium-dropdown-20260912'") &&
  H.includes("const expectedSwVersion = 'v243-premium-dropdown-20260912'") &&
  H.includes('sw.js?v=v243-premium-dropdown-20260912') &&
  H.includes('admission-hub-shell-v243-premium-dropdown-20260912'));
...
await test('premium account and institution assets use synchronized cache-busting versions',
  ['account-access.css?v=20260912-premium-dropdown-v1', 'account-access.js?v=20260912-premium-dropdown-v1', 'institutions-bd.js?v=bd-institutions-v1']
    .every(asset => H.includes(asset) && SW.includes(asset)) &&
  H.indexOf('institutions-bd.js?v=bd-institutions-v1') < H.indexOf('account-access.js?v=20260912-premium-dropdown-v1'));
