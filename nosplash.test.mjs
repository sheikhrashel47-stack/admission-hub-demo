...
/* — ভার্সন সামঞ্জস্য — */
t('১৪. index ↔ sw BUILD_ID v207-aiagent-20260908 মিলেছে', html.includes('v207-aiagent-20260908') && sw.includes("const BUILD_ID = 'v207-aiagent-20260908'"));
...
t('১৬. session-persist + premium-auth guest-first অক্ষত', html.includes('session-persist.js?v=session-v1') && html.includes('premium-auth.js?v=p3-auth-guest-v201'));
