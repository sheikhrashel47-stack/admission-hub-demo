...
/* — ভার্সন সামঞ্জস্য — */
t('১৪. index ↔ sw BUILD_ID v192-gfix-20260906 মিলেছে', html.includes('v192-gfix-20260906') && sw.includes("const BUILD_ID = 'v192-gfix-20260906'"));
...
t('১৬. session-persist + premium-auth guest-first অক্ষত', html.includes('session-persist.js?v=session-v1') && html.includes('premium-auth.js?v=p3-auth-guest-v192'));
