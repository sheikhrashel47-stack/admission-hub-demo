...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && H.includes("const expectedSwVersion = 'v225-firebase-multimethod-20260910'"));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && H.includes("const expectedSwVersion = 'v225-firebase-multimethod-20260910'") && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && H.includes('sw.js?v=v225-firebase-multimethod-20260910') && SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
