...
t('২. ai-agent-chat.js স্ক্রিপ্ট-ট্যাগ (chatv1)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && H.includes('sw.js?v=v216-aiagent-20260908') && H.includes("const expectedSwVersion = 'v216-aiagent-20260908'"));
t('৩২. sw APP_SHELL: ai-agent-chat chatv1 + dash2f6', SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && SW.includes('./dashboard-v2.js?v=dash2f6') && H.includes('dashboard-v2.js?v=dash2f6'));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && H.includes("const expectedSwVersion = 'v216-aiagent-20260908'") && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));


/* ── ৮. v211 (chatv4): ফুল-স্ক্রিন AI + Final Composer Workflow ── */
t('৩৮. AI-পেজ ফুল-স্ক্রিন: nav-hide + back-button + নিজস্ব-scroll root', UI.includes("document.querySelector('.bottomnav')") && UI.includes("navBar.style.display = 'none'") && UI.includes('aiHomeBtn') && UI.includes('function backHome()') && UI.includes("window.navigate('dashboard')") && UI.includes('height:100dvh;min-height:100dvh'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9') && H.includes('sw.js?v=v216-aiagent-20260908') && SW.includes("const BUILD_ID = 'v216-aiagent-20260908'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv9'));
