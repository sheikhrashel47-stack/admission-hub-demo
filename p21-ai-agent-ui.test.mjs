...
t('৩১. sw BUILD_ID v208-aiagent (index-marker + expectedSwVersion)', SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && H.includes('sw.js?v=v234-premium-onboarding-20260911') && H.includes("const expectedSwVersion = 'v234-premium-onboarding-20260911'"));
...
t('৩৭. chatv3 + v210 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && H.includes("const expectedSwVersion = 'v234-premium-onboarding-20260911'") && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৪১. chatv4 + v211 অখণ্ডতা (index+sw)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৪৭. chatv5 + v212 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৫২. chatv6 + v213 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৫৭. chatv7 + v214 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৬২. chatv8 + v215 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৬৭. chatv9 + v216 অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
...
t('৭৪. chatv14 guest + current shell অখণ্ডতা', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && H.includes('sw.js?v=v234-premium-onboarding-20260911') && SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && SW.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
