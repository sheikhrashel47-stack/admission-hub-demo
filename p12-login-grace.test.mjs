...
t('১৬. sw BUILD_ID v211-aiagent-20260908 (index-marker + sw.js)', SW.includes("const BUILD_ID = 'v211-aiagent-20260908'") && H.includes('sw.js?v=v211-aiagent-20260908'));
t('১৭. SW-ব্লক expectedSwVersion/cur = v196 (মৃত v179-হার্ডকোড বাদ)', H.includes("const expectedSwVersion = 'v211-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v211-aiagent-20260908'") && !H.includes('v179-aiengine-20260903'));
