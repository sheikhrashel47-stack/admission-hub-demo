...
const BUILD_ID = 'v236-static-welcome-20260911';
...
const APP_SHELL = [
  ...
  './account-access.css?v=20260911-static-reference-welcome-v3',
  './institutions-bd.js?v=bd-institutions-v1',
  './account-access.js?v=20260911-static-reference-welcome-v3',
  './data-protection.js?v=dp-v3-fastboot',
  './dashboard-v2.js?v=dash2f9',
  './icons/icon-192.png',
  './icons/icon-512.png'
];
