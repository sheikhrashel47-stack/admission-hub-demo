...
const BUILD_ID = 'v237-main-ai-20260911';
...
const APP_SHELL = [
  ...
  './account-access.css?v=20260911-static-reference-welcome-v3-ai-scope',
  './institutions-bd.js?v=bd-institutions-v1',
  './account-access.js?v=20260911-static-reference-welcome-v3-ai-scope',
