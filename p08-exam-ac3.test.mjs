...
t('sw BUILD_ID v201-gfix-20260907', SW.includes("const BUILD_ID = 'v201-gfix-20260907'"));
t('index sw-marker v201-gfix-20260907', H.includes('sw.js?v=v201-gfix-20260907'));
