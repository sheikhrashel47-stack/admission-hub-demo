...
t('sw BUILD_ID current shell', SW.includes("const BUILD_ID = 'v236-static-welcome-20260911'"));
t('index sw-marker current shell', H.includes('sw.js?v=v236-static-welcome-20260911'));
