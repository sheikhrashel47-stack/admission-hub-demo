...
t('১৩. sw BUILD_ID v202-gfix-20260907 (index-marker + expectedSwVersion + cur)', SW.includes("const BUILD_ID = 'v202-gfix-20260907'") && H.includes('sw.js?v=v202-gfix-20260907') && H.includes("const expectedSwVersion = 'v202-gfix-20260907'") && H.includes("const cur = 'admission-hub-shell-v202-gfix-20260907'"));
