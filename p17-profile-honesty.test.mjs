...
t('১৩. sw BUILD_ID v201-gfix-20260907 (index-marker + expectedSwVersion + cur)', SW.includes("const BUILD_ID = 'v201-gfix-20260907'") && H.includes('sw.js?v=v201-gfix-20260907') && H.includes("const expectedSwVersion = 'v201-gfix-20260907'") && H.includes("const cur = 'admission-hub-shell-v201-gfix-20260907'"));
