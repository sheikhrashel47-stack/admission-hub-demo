...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f4 (index+sw) + BUILD_ID v200', H.includes('dashboard-v2.js?v=dash2f4') && SW.includes("'./dashboard-v2.js?v=dash2f4'") && SW.includes("const BUILD_ID = 'v204-gfix-20260907'") && H.includes('sw.js?v=v204-gfix-20260907'));
