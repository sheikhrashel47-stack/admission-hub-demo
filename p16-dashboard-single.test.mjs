...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f7 (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f7') && SW.includes("'./dashboard-v2.js?v=dash2f7'") && SW.includes("const BUILD_ID = 'v230-telegram-otp-20260910'") && H.includes('sw.js?v=v230-telegram-otp-20260910'));
