...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f3 (index+sw) + BUILD_ID v200', H.includes('dashboard-v2.js?v=dash2f3') && SW.includes("'./dashboard-v2.js?v=dash2f3'") && SW.includes("const BUILD_ID = 'v202-gfix-20260907'") && H.includes('sw.js?v=v202-gfix-20260907'));
