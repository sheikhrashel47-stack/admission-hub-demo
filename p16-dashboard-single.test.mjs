...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f8 (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f8') && SW.includes("'./dashboard-v2.js?v=dash2f8'") && SW.includes("const BUILD_ID = 'v235-reference-onboarding-20260911'") && H.includes('sw.js?v=v235-reference-onboarding-20260911'));
