...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f10-main-ai (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f10-main-ai') && SW.includes("'./dashboard-v2.js?v=dash2f10-main-ai'") && SW.includes("const BUILD_ID = 'v241-zero-raster-3d-student-20260911'") && H.includes('sw.js?v=v241-zero-raster-3d-student-20260911'));
