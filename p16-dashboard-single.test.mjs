...
t('৫. ভার্সন: dashboard-v2.js ?v=dash2f7 (index+sw) + current BUILD_ID', H.includes('dashboard-v2.js?v=dash2f7') && SW.includes("'./dashboard-v2.js?v=dash2f7'") && SW.includes("const BUILD_ID = 'v232-auth-ui-skew-20260911'") && H.includes('sw.js?v=v232-auth-ui-skew-20260911'));
