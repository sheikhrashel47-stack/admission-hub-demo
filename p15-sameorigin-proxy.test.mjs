...
t('১৪. sw BUILD_ID v211-aiagent-20260908 (index-marker + sw.js + expectedSwVersion + cur)', SW.includes("const BUILD_ID = 'v211-aiagent-20260908'") && H.includes('sw.js?v=v211-aiagent-20260908') && H.includes("const expectedSwVersion = 'v211-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v211-aiagent-20260908'"));
