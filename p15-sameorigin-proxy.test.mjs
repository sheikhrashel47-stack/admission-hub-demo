...
t('১৪. sw BUILD_ID v206-aiagent-20260908 (index-marker + sw.js + expectedSwVersion + cur)', SW.includes("const BUILD_ID = 'v206-aiagent-20260908'") && H.includes('sw.js?v=v206-aiagent-20260908') && H.includes("const expectedSwVersion = 'v206-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v206-aiagent-20260908'"));
