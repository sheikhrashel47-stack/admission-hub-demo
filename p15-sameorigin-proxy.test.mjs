...
t('১৪. sw BUILD_ID v207-aiagent-20260908 (index-marker + sw.js + expectedSwVersion + cur)', SW.includes("const BUILD_ID = 'v207-aiagent-20260908'") && H.includes('sw.js?v=v207-aiagent-20260908') && H.includes("const expectedSwVersion = 'v207-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v207-aiagent-20260908'"));
