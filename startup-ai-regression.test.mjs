...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v243-premium-dropdown-20260912'") && H.includes("const expectedSwVersion = 'v243-premium-dropdown-20260912'") && H.includes('sw.js?v=v243-premium-dropdown-20260912') && H.includes('account-access.js?v=20260912-premium-dropdown-v1') && SW.includes('account-access.js?v=20260912-premium-dropdown-v1') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
