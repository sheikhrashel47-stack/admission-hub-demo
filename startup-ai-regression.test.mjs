...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'") && H.includes("const expectedSwVersion = 'v242-hero-personal-dob-modern-20260912'") && H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912') && H.includes('account-access.js?v=20260912-hero-personal-dob-modern-v2') && SW.includes('account-access.js?v=20260912-hero-personal-dob-modern-v2') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
