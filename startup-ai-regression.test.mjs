...
test('১২. build/cache/AI asset versions are synchronized',
  SW.includes("const BUILD_ID = 'v226-passkey-canary-20260910'") && H.includes("const expectedSwVersion = 'v226-passkey-canary-20260910'") && H.includes('sw.js?v=v226-passkey-canary-20260910') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv14-guest') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv14-guest'));
