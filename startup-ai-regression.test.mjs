...
test('১২. build/cache/static-Welcome and main-app AI versions are synchronized',
  SW.includes("const BUILD_ID = 'v241-zero-raster-3d-student-20260911'") && H.includes("const expectedSwVersion = 'v241-zero-raster-3d-student-20260911'") && H.includes('sw.js?v=v241-zero-raster-3d-student-20260911') && H.includes('account-access.js?v=20260911-zero-raster-3d-student-v1') && SW.includes('account-access.js?v=20260911-zero-raster-3d-student-v1') && H.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity') && SW.includes('ai-agent-chat.js?v=agent-f1-ui-chatv15-identity'));
