...
const swVer = (sw.match(/BUILD_ID = 'v([0-9]+)-(?:authapi|uniunit|email|splash3d|blankfix|introfix|guest|nosplash)(?:-(?:fix|guard|design))?-?(\d{8})'/) || [])[1];
const idxVer = (idx.match(/sw\.js\?v=v([0-9]+)-(?:authapi|uniunit|email|splash3d|blankfix|introfix|guest|nosplash)(?:-(?:fix|guard|design))?-?(\d{8})/) || [])[1];
