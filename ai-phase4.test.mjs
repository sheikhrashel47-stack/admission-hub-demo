...
t('৯. ৫-ট্যাব-নেভি অটুট', /NAV_TABS=.*key:'dashboard'.*key:'question-bank'.*key:'exam'.*key:'history'.*key:'profile'/s.test(H));
t('১০. dashboard-v2 সংস্করণ dash2f5 + sw BUILD_ID v205 (ক্যাশ-বাস্ট)', H.includes('dashboard-v2.js?v=dash2f5') && SW.includes("const BUILD_ID = 'v205-gfix-20260908'") && H.includes('sw.js?v=v205-gfix-20260908'));
