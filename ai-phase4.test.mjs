...
t('১২. নতুন Agent-প্রিমিয়াম-UI + streaming + টোকেন-ভিত্তিক কল (কোনো সিক্রেট-নেই)', H.includes('./ai-agent-chat.js?v=agent-f1-ui-chatv1') && UI.includes('/api/ai/chat') && UI.includes('ahPubToken') && !UI.includes('x-goog-api-key') && !UI.includes('generativelanguage'));
...
t('১০. dashboard-v2 সংস্করণ dash2f6 + sw BUILD_ID v206 (ক্যাশ-বাস্ট)', H.includes('dashboard-v2.js?v=dash2f6') && SW.includes("const BUILD_ID = 'v208-aiagent-20260908'") && H.includes('sw.js?v=v208-aiagent-20260908'));
