...
t('৪. premium-auth.js/css v193 query-তে লোড হয়', /premium-auth\.js\?v=p3-auth-guest-v199/.test(html) && /premium-auth\.css\?v=p3-auth-guest-v196/.test(html));
t('৫. sw build v200-gfix-20260907 (index + sw.js)',
  /v200-gfix-20260907/.test(html) && /v200-gfix-20260907/.test(readFileSync('/home/user/demo/sw.js', 'utf8')));
