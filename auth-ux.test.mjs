...
t('৪. premium-auth.js/css v193 query-তে লোড হয়', /premium-auth\.js\?v=p3-auth-guest-v201/.test(html) && /premium-auth\.css\?v=p3-auth-guest-v196/.test(html));
t('৫. sw build v211-aiagent-20260908 (index + sw.js)',
  /v211-aiagent-20260908/.test(html) && /v211-aiagent-20260908/.test(readFileSync('/home/user/demo/sw.js', 'utf8')));
