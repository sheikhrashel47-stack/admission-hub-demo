...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v241-zero-raster-3d-student-20260911'") && H.includes('sw.js?v=v241-zero-raster-3d-student-20260911') && H.includes("const expectedSwVersion = 'v241-zero-raster-3d-student-20260911'") && H.includes("const cur = 'admission-hub-shell-v241-zero-raster-3d-student-20260911'"));
