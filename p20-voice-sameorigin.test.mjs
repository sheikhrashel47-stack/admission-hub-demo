...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v238-personal-20260911'") && H.includes('sw.js?v=v238-personal-20260911') && H.includes("const expectedSwVersion = 'v238-personal-20260911'") && H.includes("const cur = 'admission-hub-shell-v238-personal-20260911'"));
