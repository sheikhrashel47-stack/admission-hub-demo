...
t('৬. el-voice-v106 stays deferred outside the lean current app shell', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && !SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'") && H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912') && H.includes("const expectedSwVersion = 'v242-hero-personal-dob-modern-20260912'") && H.includes("const cur = 'admission-hub-shell-v242-hero-personal-dob-modern-20260912'"));
