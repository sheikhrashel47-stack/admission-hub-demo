...
t('৬. el-voice-v106 (index+sw) + BUILD_ID v211-aiagent-20260908 (সব-মার্কার)', H.includes('vocabulary-elevenlabs.js?v=el-voice-v106') && SW.includes("'./vocabulary-elevenlabs.js?v=el-voice-v106'") && SW.includes("const BUILD_ID = 'v211-aiagent-20260908'") && H.includes('sw.js?v=v211-aiagent-20260908') && H.includes("const expectedSwVersion = 'v211-aiagent-20260908'") && H.includes("const cur = 'admission-hub-shell-v211-aiagent-20260908'"));
