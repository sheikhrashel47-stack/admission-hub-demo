...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f9 (index+sw) + current BUILD_ID', H.includes('<script defer src="./dashboard-v2.js?v=dash2f9"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f9'") && SW.includes("const BUILD_ID = 'v236-static-welcome-20260911'") && H.includes('sw.js?v=v236-static-welcome-20260911') && H.includes("const expectedSwVersion = 'v236-static-welcome-20260911'") && !H.includes('v196-gfix'));
