...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f7 (index+sw) + current BUILD_ID', H.includes('<script defer src="./dashboard-v2.js?v=dash2f7"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f7'") && SW.includes("const BUILD_ID = 'v226-passkey-canary-20260910'") && H.includes('sw.js?v=v226-passkey-canary-20260910') && H.includes("const expectedSwVersion = 'v226-passkey-canary-20260910'") && !H.includes('v196-gfix'));
