...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f8 (index+sw) + current BUILD_ID', H.includes('<script defer src="./dashboard-v2.js?v=dash2f8"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f8'") && SW.includes("const BUILD_ID = 'v235-reference-onboarding-20260911'") && H.includes('sw.js?v=v235-reference-onboarding-20260911') && H.includes("const expectedSwVersion = 'v235-reference-onboarding-20260911'") && !H.includes('v196-gfix'));
