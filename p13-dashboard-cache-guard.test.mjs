...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f6 (index+sw) + BUILD_ID v200', H.includes('<script defer src="./dashboard-v2.js?v=dash2f6"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f6'") && SW.includes("const BUILD_ID = 'v210-aiagent-20260908'") && H.includes('sw.js?v=v210-aiagent-20260908') && H.includes("const expectedSwVersion = 'v210-aiagent-20260908'") && !H.includes('v196-gfix'));
