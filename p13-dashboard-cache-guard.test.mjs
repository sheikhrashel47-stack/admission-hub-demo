...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f5 (index+sw) + BUILD_ID v200', H.includes('<script defer src="./dashboard-v2.js?v=dash2f5"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f5'") && SW.includes("const BUILD_ID = 'v205-gfix-20260908'") && H.includes('sw.js?v=v205-gfix-20260908') && H.includes("const expectedSwVersion = 'v205-gfix-20260908'") && !H.includes('v196-gfix'));
