...
t('৫. ভার্সন-অখণ্ডতা: dashboard-v2.js ?v=dash2f1 (index+sw) + BUILD_ID v197', H.includes('<script defer src="./dashboard-v2.js?v=dash2f1"></script>') && SW.includes("'./dashboard-v2.js?v=dash2f1'") && SW.includes("const BUILD_ID = 'v198-gfix-20260907'") && H.includes('sw.js?v=v198-gfix-20260907') && H.includes("const expectedSwVersion = 'v198-gfix-20260907'") && !H.includes('v196-gfix'));
