...
(function () {
  ...
  const T = lang === 'en' ? {
    ...
    ph: 'Ask Admission Hub AI...', thinking: 'Thinking', understanding: 'Understanding your question...', creating: 'Creating questions...',
    ...
    ph: 'Ask Admission Hub AI...', thinking: 'Thinking', understanding: 'তোমার প্রশ্নটা বুঝছি…', creating: 'প্রশ্ন বানাচ্ছি…',
  ...
  style.textContent = `
    .ai-agent-root{--r-s:10px;--r-m:14px;--r-card:18px;--r-l:22px;--r-float:28px;--r-pill:999px;
      ...
      background:var(--ai-bg,#F7F9F8);color:var(--ai-ink,#16302A);
    ...
    /* ── header ── */
    .ai-agent-head{position:sticky;top:0;z-index:9;display:flex;align-items:center;gap:12px;padding:12px 16px 10px;background:var(--ai-bg,#F7F9F8);border-bottom:1px solid var(--ai-line,rgba(15,107,79,.1));transition:background .35s ease}
    ...
    .ai-msg.user .bubble{max-width:82%;background:var(--ai-user,#0E5F45);color:#fff;border-radius:18px 18px 6px 18px;padding:11px 14px;font-size:15px;line-height:1.6;white-space:pre-wrap;word-break:break-word}
    ...
    .ai-msg.ai{background:var(--ai-card,#fff);border:1px solid var(--ai-line,rgba(15,107,79,.1));border-radius:var(--r-card);padding:14px 15px 10px;box-shadow:0 6px 20px rgba(23,58,43,.05)}
    .ai-msg-head{display:flex;align-items:center;gap:7px;font-size:12px;font-weight:800;color:#0E6B4F;margin-bottom:8px}
    ...
    .ai-msg-body{font-size:15px;line-height:1.72}
    .ai-msg-body h1,.ai-msg-body h2,.ai-msg-body h3{font-size:17.5px;font-weight:800;color:var(--ai-ink,#16302A);margin:8px 0 7px;letter-spacing:-.01em;line-height:1.4}
    .ai-msg-body p{margin:7px 0}
    .ai-msg-body ul,.ai-msg-body ol{margin:7px 0;padding-left:21px}
    .ai-msg-body li{margin:4px 0}
    .ai-msg-body code{background:var(--ai-mint,#EFF7F2);border-radius:6px;padding:1px 6px;font-size:13px;font-family:ui-monospace,Menlo,monospace}
    .ai-msg-body pre{background:#0E2A20;color:#D8F3E6;border-radius:13px;padding:12px 13px;overflow-x:auto;font-size:12.5px;margin:9px 0}
    ...
    .ai-formula{background:var(--ai-mint,#EFF7F2);border:1px solid rgba(15,107,79,.14);border-radius:var(--r-m);padding:13px;margin:9px 0;text-align:center;font-family:Georgia,"Times New Roman",serif;font-style:italic;font-size:19px;color:var(--ai-ink,#16302A)}
    .ai-callout{border-radius:var(--r-m);padding:11px 13px;margin:9px 0;font-size:14px;line-height:1.68;border:1px solid}
    ...
    .ai-msg-body table{width:100%;border-collapse:collapse;margin:9px 0;font-size:13.5px}
    .ai-msg-body th,.ai-msg-body td{border:1px solid var(--ai-line,rgba(15,107,79,.16));padding:8px 9px;text-align:left}
    ...
    .ai-compose{display:flex;align-items:center;gap:8px;background:var(--ai-card,#fff);border:1px solid var(--ai-line,rgba(15,107,79,.18));border-radius:var(--r-float);padding:7px 8px;box-shadow:0 12px 30px rgba(23,58,43,.1)}
    .ai-agent-root[data-theme=dark] .ai-compose{box-shadow:0 12px 30px rgba(0,0,0,.5)}
    .ai-plus{width:38px;height:38px;flex:0 0 auto;border-radius:50%;border:0;background:var(--ai-mint,#E4F3EC);color:#0E6B4F;font-size:20px;cursor:pointer;display:grid;place-items:center;transition:transform .15s}
    .ai-plus:active{transform:scale(.9)}
    .ai-compose textarea{flex:1;min-width:0;border:0;background:none;resize:none;font:inherit;font-size:15px;line-height:1.5;max-height:120px;padding:9px 2px;outline:0;color:var(--ai-ink,#16302A)}
    .ai-compose textarea::placeholder{color:#93A8A0}
    .ai-mic{width:38px;height:38px;flex:0 0 auto;border-radius:50%;border:1px solid var(--ai-line,rgba(15,107,79,.2));background:none;color:#0E6B4F;font-size:16px;cursor:pointer;display:grid;place-items:center}
    ...
    .ai-send{width:40px;height:40px;flex:0 0 auto;border-radius:50%;border:0;background:linear-gradient(140deg,#12805A,#0E5F45);color:#fff;font-size:16px;cursor:pointer;display:grid;place-items:center;transition:transform .15s}
    .ai-send:active{transform:scale(.9)}
    .ai-send.stop{background:linear-gradient(140deg,#C0392B,#A93226)}
    .ai-send:disabled{opacity:.5}
    .ai-attach-chip{display:flex;align-items:center;gap:9px;background:var(--ai-card,#fff);border:1px solid var(--ai-line,rgba(15,107,79,.16));border-radius:var(--r-m);padding:8px 11px;margin:0 2px 8px;font-size:12.5px;animation:aiIn .2s ease both}
    ...
    /* ── bottom sheet ── */
    .ai-sheetback{position:fixed;inset:0;background:rgba(8,24,18,.4);backdrop-filter:blur(4px);z-index:60;display:flex;align-items:flex-end;justify-content:center;animation:aiFade .2s ease}
    @keyframes aiFade{from{opacity:0}}
    .ai-sheet{width:100%;max-width:760px;max-height:82dvh;overflow-y:auto;background:var(--ai-card,#fff);border-radius:var(--r-l) var(--r-l) 0 0;padding:16px 16px calc(18px + env(safe-area-inset-bottom));animation:aiSheet .26s ease;color:var(--ai-ink,#16302A)}
    ...
    @media(max-width:430px){.ai-msg-body{font-size:14.5px}}
  ...
  function closeAttach() { attachOpen = false; const sb = document.getElementById('aiSheetView'); if (sb) sb.remove(); }

  /* ── attachments sheet ── */
  function sheet() {
    const back = document.createElement('div');
    back.className = 'ai-sheetback'; back.id = 'aiSheetView';
    back.innerHTML = `<div class="ai-sheet"><div class="ai-sheet-h">${esc(T.addToConv)}</div>
  ...
  function autoGrow() { const i = document.getElementById('aiInput'); if (i) { i.style.height = 'auto'; i.style.height = Math.min(i.scrollHeight, 120) + 'px'; } }
  ...
  function render() {
    ...
    if (plusBtn) plusBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      if (attachOpen) closeAttach(); else { attachOpen = true; closeMenu(); document.body.appendChild(sheet()); }
    });
