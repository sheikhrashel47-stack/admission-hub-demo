...
## P20-final-২ — মালিক-নতুন-key + সার্ভার-সাইড-সব (২০২৬-০৯-০৭, রাত)
- মালিক: "ডেটা-অনেক-তাই-PWA-রিমুভ-করা-যাবে-না — হই-মতো-করে-দাও" + নতুন-ElevenLabs-key-দিলেন।
- সর্বশেষ-যাচাই: worker-চেইন ১২০%-সুস্থ (ক্যাশ-বাইপাস-অভিনব-শব্দ-এও-200/audio-mpeg — পুরনো-key-ও-বেঁচে-ছিল); হুবহু-ব্রাউজার-পথ (github.io-Origin): OPTIONS 204 + ACAO=shetikhrashel47-stack.github.io + POST 200। → মালিক-ফোনে-অবশিষ্ট-সমস্যা: পুরনো-ক্লায়েন্ট (ক্যাশ-থাকা-পুরনো-বিল্ড)।
- **নতুন-key-ইনস্টল — রিপোতে-নয়:** GitHub-Secret `ELEVENLABS_API_KEY` (libsodium-encrypted, API-দিয়ে) → workflow `voice-secret.yml` (wrangler secret put --name admission-voice; **কোড+KV-বাইন্ডিং-অটুট**, /health-এ kv:true-অক্ষত) → লাইভ-যাচাই: অভিনব-শব্দ-`x-voice-cache: miss` → 200/audio-mpeg (নতুন-key-এ-আসল-ElevenLabs-কল-সফল)।
- PWA-আপডেট-পথ (কোনো-রিমুভ/ডেটা-ক্ষতি-নয়): hub-sw-এ skipWaiting+clients.claim+unregister-সেলফ-হিল ↔ নতুন-ইনডেক্স। **মালিক-করণীয়: অ্যাপ-খোলো → সম্পূর্ণ-বন্ধ → আবার-খোলো (২-বার)** — ডেটা-ইনডেক্সডবি-থাকে।
