...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v240-code-native-entry-20260911'") && H.includes('sw.js?v=v240-code-native-entry-20260911'));
