...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v243-premium-dropdown-20260912'") && H.includes('sw.js?v=v243-premium-dropdown-20260912'));
