...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v234-premium-onboarding-20260911'") && H.includes('sw.js?v=v234-premium-onboarding-20260911'));
