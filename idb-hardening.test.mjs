...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v226-passkey-canary-20260910'") && H.includes('sw.js?v=v226-passkey-canary-20260910'));
