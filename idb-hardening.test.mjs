...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v236-static-welcome-20260911'") && H.includes('sw.js?v=v236-static-welcome-20260911'));
