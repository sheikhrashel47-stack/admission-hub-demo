...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v231-account-identity-20260910'") && H.includes('sw.js?v=v231-account-identity-20260910'));
