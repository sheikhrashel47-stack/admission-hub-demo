...
/* ৪ — ভার্সন */
t('sw BUILD_ID v192-gfix-20260906', SW.includes("const BUILD_ID = 'v192-gfix-20260906'"));
t('index sw-marker v192-gfix-20260906', H.includes('sw.js?v=v192-gfix-20260906'));
