...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'") && H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912'));
