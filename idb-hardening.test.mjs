...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v227-google-canary-20260910'") && H.includes('sw.js?v=v227-google-canary-20260910'));
