...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v241-zero-raster-3d-student-20260911'") && H.includes('sw.js?v=v241-zero-raster-3d-student-20260911'));
