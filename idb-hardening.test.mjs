...
test('service-worker build marker is synchronized', SW.includes("const BUILD_ID = 'v221-account-retired-20260908'") && H.includes('sw.js?v=v221-account-retired-20260908'));
