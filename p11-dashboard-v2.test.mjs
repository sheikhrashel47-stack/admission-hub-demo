...
t('sw BUILD_ID v225-firebase-multimethod-20260910', SW.includes("const BUILD_ID = 'v225-firebase-multimethod-20260910'"));
t('index sw-marker v195', H.includes('sw.js?v=v225-firebase-multimethod-20260910'));
