...
t('sw BUILD_ID v242-3d-dob-wheel-20260912', SW.includes("const BUILD_ID = 'v242-3d-dob-wheel-20260912'"));
t('index sw-marker v195', H.includes('sw.js?v=v242-3d-dob-wheel-20260912'));
