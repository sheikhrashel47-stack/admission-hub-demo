...
t('sw BUILD_ID v243-premium-dropdown-20260912', SW.includes("const BUILD_ID = 'v243-premium-dropdown-20260912'"));
t('index sw-marker v195', H.includes('sw.js?v=v243-premium-dropdown-20260912'));
