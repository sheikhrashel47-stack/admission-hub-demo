...
t('sw BUILD_ID v240-code-native-entry-20260911', SW.includes("const BUILD_ID = 'v240-code-native-entry-20260911'"));
t('index sw-marker v195', H.includes('sw.js?v=v240-code-native-entry-20260911'));
