...
t('sw BUILD_ID v230-telegram-otp-20260910', SW.includes("const BUILD_ID = 'v230-telegram-otp-20260910'"));
t('index sw-marker v195', H.includes('sw.js?v=v230-telegram-otp-20260910'));
