...
t('sw BUILD_ID v242-hero-personal-dob-modern-20260912', SW.includes("const BUILD_ID = 'v242-hero-personal-dob-modern-20260912'"));
t('index sw-marker v195', H.includes('sw.js?v=v242-hero-personal-dob-modern-20260912'));
...
t('৫ Study Insight (saved progress + Practice Weak Topic)', V2.includes('Study Insight') && V2.includes('>Progress</span>') && V2.includes('Practice Weak Topic →') && V2.includes('insightText'));
