...
t('sw BUILD_ID v231-account-identity-20260910', SW.includes("const BUILD_ID = 'v231-account-identity-20260910'"));
t('index sw-marker v195', H.includes('sw.js?v=v231-account-identity-20260910'));
