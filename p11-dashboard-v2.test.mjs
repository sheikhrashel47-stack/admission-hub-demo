...
t('sw BUILD_ID v232-auth-ui-skew-20260911', SW.includes("const BUILD_ID = 'v232-auth-ui-skew-20260911'"));
t('index sw-marker v195', H.includes('sw.js?v=v232-auth-ui-skew-20260911'));
